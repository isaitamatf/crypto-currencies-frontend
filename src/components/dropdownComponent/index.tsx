 ...
 */
function useOutsideAlerter(ref: any, dropdownIsOpen: any, setDropdownIsOpen: any) {
  useEffect(() => {
 ...
 * @returns {JSX}
 */
const DropdownComponent: React.FC<DropdownComponentProps> = ({ isMobile, optionSelected, options, setOption }) => {
  ...
  const findOptionSelected = () =>
    options.find((o: any) => o.value === optionSelected);
